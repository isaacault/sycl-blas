...
#ifndef SYCL_BLAS_BLAS_REDUCTION_INTERFACE_HPP
#define SYCL_BLAS_BLAS_REDUCTION_INTERFACE_HPP
...
typename executor_t::policy_t::event_t _reduction(executor_t& ex, 
  ...
  if (two_step_reduction) {
    ...
    auto temp_buffer =
        ...
        cl::sycl::malloc_device<element_t>(rows * group_count_cols, policy_handler.get_queue());
#else
